      ...
      <div className="rounded-2xl bg-card border border-border p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-display text-xl font-bold">{t("home.catalogStrip.title")}</h2>
          ...
          <Link
            href="/browse"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-accent text-[#0b0f14] text-sm font-medium hover:bg-accent-hover transition-colors"
          >
